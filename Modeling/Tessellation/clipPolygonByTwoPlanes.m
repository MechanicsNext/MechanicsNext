function polygon_out = clipPolygonByTwoPlanes(polygon_in, polygon_extent, bbox_half_width, plane_1, plane_2)
...
try
    polygon_out = clipConvexPolygon3dHP(clipConvexPolygon3dHP([planePoint(polygon_out, [-polygon_extent -polygon_extent]); planePoint(polygon_out, [-polygon_extent polygon_extent]); planePoint(polygon_out, [polygon_extent polygon_extent]); planePoint(polygon_out, [polygon_extent -polygon_extent])], plane_1), plane_2);
catch
end
% Now clip by the bounding box
% Right now the bounding box is hardcoded to be 2x2x2
