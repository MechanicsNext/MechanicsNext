function polygon_out = clipPolygonByOnePlanes(polygon_in, polygon_extent, bbox_half_width, plane_1)
polygon_out = polygon_in;

%disp('One plane')

% Clip the polygon by the plane
try
    polygon_out = clipConvexPolygon3dHP([planePoint(polygon_out, [-polygon_extent -polygon_extent]); planePoint(polygon_out, [-polygon_extent polygon_extent]); planePoint(polygon_out, [polygon_extent polygon_extent]); planePoint(polygon_out, [polygon_extent -polygon_extent])], plane_1);
catch
end
